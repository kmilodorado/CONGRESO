<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrarView.aspx.cs" Inherits="Eventos.Vistas.Publico.RegistrarView1" %>
                                    ...
                                    <form id="form1" runat="server">
                                        ...
                                        <div class="wizard-navigation">
                                            <ul class="nav nav-pills">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" href="#address" data-toggle="tab" role="tab">Cuestionario</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    <div class="col-md-12 ml-auto">
                                                        <asp:Repeater ID="Repeater1" runat="server">
                                                            <ItemTemplate>
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <asp:Label ID="LB_PREGUNTA" CssClass="font-weight-bold" runat="server" Text='<%# Eval("PREG_ITEM") %>'></asp:Label>
                                                                        <div class="form-group">
                                                                            <div class="input-group">
                                                                                <div class="input-group-prepend">
                                                                                    <span class="input-group-text">
                                                                                ...
                                                                                <asp:TextBox ID='TXT_RESPUESTA' required="required" CssClass="form-control" placeholder="Tu respuesta..." runat="server"></asp:TextBox>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
