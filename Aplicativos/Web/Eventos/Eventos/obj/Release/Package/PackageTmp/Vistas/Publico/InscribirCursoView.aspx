<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InscribirCursoView.aspx.cs" Inherits="Eventos.Vistas.Publico.InscribirCursoView" %>
                                    ...
                                    <form id="form1" runat="server">
                                        <div class="card-header text-center">
                                            ...
                                            <div class="col-md-12 text-center">
                                                <asp:Image ID="Image2" ImageUrl="~/Imagen/Evento/logo cacao tic.png" Width="200" Height="100" runat="server" />
                                            </div>
                                            <br />
                                        ...
                                        <div class="wizard-navigation">
                                            <ul class="nav nav-pills">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" href="#address" data-toggle="tab" role="tab">Seleccionar Curso</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="card-body">
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane" id="address">
                                                    <div class="col-md-12 ml-auto">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <h4 class="text-center font-weight-bold">CURSOS PRE CONGRESO 18 JUNIO </h4>
                                                                <br />
                                                                <asp:RadioButtonList ID="RB_CURSO_18" ValidateRequestMode="Enabled" Style="color: black"   runat="server">
                                                                </asp:RadioButtonList>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <h4 class="text-center font-weight-bold">CURSOS PRE CONGRESO 19 JUNIO </h4>
                                                                <br />
                                                                <asp:RadioButtonList ID="RB_CURSO_19" ValidateRequestMode="Disabled" Style="color: black" runat="server">
                                                                </asp:RadioButtonList>
