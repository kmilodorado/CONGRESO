<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Privado/SuperAdmin/PagPrivateMaster.Master" AutoEventWireup="true" CodeBehind="GestionarPermisoParticipanteView.aspx.cs" Inherits="Eventos.Vistas.Privado.SuperAdmin.GestionarPermisoParticipanteView" %>
        ...
        <div class="col-md-12">
            <div class="card ">
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-md-12">
                            <asp:DropDownList ID="DDL_PARTICIPANTE" CssClass="selectpicker" data-style="btn select-with-transition" OnSelectedIndexChanged="DDL_PARTICIPANTE_SelectedIndexChanged" AutoPostBack="true" title=" Seleccionar Rol" runat="server">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <hr />
